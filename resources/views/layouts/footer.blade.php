<footer id="contact-us" class="bg-neutral-dark text-white pt-12 pb-8 md:pt-24 md:pb-12 overflow-hidden relative">
    <!-- Abstract Glow -->
    <div class="absolute -bottom-24 -left-24 w-96 h-96 bg-primary/20 rounded-full blur-[120px]"></div>

    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-y-10 lg:gap-24 mb-10 md:mb-20">
            <!-- Brand Column -->
            <div data-aos="fade-up" class="col-span-2 lg:col-span-1 text-left">
                <a href="/" class="inline-flex items-center gap-4 mb-4 md:mb-8 group">
                ...
                <div class="flex items-center justify-start gap-4">
                    ...
                    <a href="https://www.instagram.com/local_gocommerce?igsh=MXI1c3I2M2Q1bndkMg==" target="_blank"
                        class="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center hover:bg-[#833AB4] transition-all group">
                        <svg class="w-5 h-5 text-slate-400 group-hover:text-white" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path
            ...
            <div data-aos="fade-up" data-aos-delay="300" class="col-span-2 lg:col-span-1 text-left">
                ...
                <div class="space-y-4">
                    ...
                    <a href="https://wa.me/6285712966082" target="_blank"
                        class="flex flex-row items-start gap-4 group/contact mt-6">
                        <div
        ...
        <div class="pt-8 md:pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div class="flex items-center justify-start gap-6 flex-wrap">
                <!-- Payment Methods -->
                <div class="w-10 h-8 rounded-lg bg-white/10 flex items-center justify-center">
                    <span class="text-[10px] font-bold text-slate-500">QRIS</span>
                </div>
                <div class="w-10 h-8 rounded-lg bg-white/10 flex items-center justify-center">
                    <span class="text-[10px] font-bold text-slate-500">BCA</span>
                </div>
                <div class="w-10 h-8 rounded-lg bg-white/10 flex items-center justify-center">
                    <span class="text-[10px] font-bold text-slate-500">DANA</span>
                </div>
            </div>
        </div>
    </div>
